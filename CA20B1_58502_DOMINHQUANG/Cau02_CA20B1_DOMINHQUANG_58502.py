...
def Cau2():
    ...
    def cv23():
        ...
        # Mở file
        f = open("CA20B1_DOMINHQUANG_58502_inp.txt", mode="r", encoding="utf-8")
        ...
        f.close
        print("***"*10)
        print("> Hoàn thành việc nhập dữ liệu từ file: CA20B1_DOMINHQUANG_58502_inp.txt ")
        print("***" * 10)
    def cv24():
        if len(data) == 0:
    ...
    def cv26():
        if len(data) == 0:
            ...
            # Ghi dữ liệu
            f = open("CA20B1_DOMINHQUANG_58502_out.txt", mode = "w", encoding="utf-8")
            ...
            f.close()
            print("**" * 20)
            print("Hoàn thành ghi ra file:CA20B1_DOMINHQUANG_58502_out.txt")
            print("**"*20)
