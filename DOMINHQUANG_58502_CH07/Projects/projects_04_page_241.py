...
Date: 29/01/1997
Program: project_04_page_241.py
Problem:
4. The twentieth-century Dutch artist Piet Mondrian developed a style of abstract
...
Figure 7-16.
 As you can see, the algorithm continues the process of subdivision until an “aesthetically right moment” is reached. In this version, the algorithm divides the
