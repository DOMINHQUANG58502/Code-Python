...
Date: 29/01/1997
Program: exercise_05_page_165.py
Problem:
5. In Chapter 4, we developed an algorithm for converting from binary to decimal. You can generalize this algorithm to work for a representation in any base.
